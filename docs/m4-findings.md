...
| File | Content |
|---|---|
| `spike/results/m4-final-run.txt` | Final M4 harness run (2026-07-06 03:38 local): **SPIKE SMOKE: ALL PASS**, 90 PASS / 0 FAIL / 3 SKIP, 366 denials 0 unexpected. Local-only per spike/.gitignore convention. |
